...
mod tests {
    ...
    // Test 1: JSON array, no content_key → each object serialised as page_content
    #[tokio::test]
    async fn test_json_array_no_content_key() {
        ...
        // page_content is the serialised JSON object; metadata is empty
    ...
    // Test 3: JSONL multiple lines → multiple documents
    #[tokio::test]
    ...
    // Test 4: Invalid JSON line in JSONL → LoaderError yielded in stream (not panic)
    #[tokio::test]
